...
const file_user_proto_rawDesc = "" +
	"\n" +
	"\n" +
	"user.proto\x1a\x1bbuf/validate/validate.proto\")\n" +
	...
	"\n" +
	"created_at\x18\x03 \x01(\tR\tcreatedAt\"V\n" +
	"\x15ChangeUsernameRequest\x12=\n" +
	"\fnew_username\x18\x01 \x01(\tB\x1a\xbaH\x17r\x15\x10\x03\x18 2\x0f^[a-zA-Z0-9_]+$R\vnewUsername2w\n" +
	"\vUserService\x12,\n" +
	"\aGetUser\x12\x0f.GetUserRequest\x1a\x10.GetUserResponse\x12:\n" +
	"\x0eChangeUsername\x12\x16.ChangeUsernameRequest\x1a\x10.GetUserResponseB\x06Z\x04./pbb\x06proto3"
...
var file_user_proto_goTypes = []any{
	...
	(*ChangeUsernameRequest)(nil), // 2: ChangeUsernameRequest
}
var file_user_proto_depIdxs = []int32{
	0, // 0: UserService.GetUser:input_type -> GetUserRequest
	2, // 1: UserService.ChangeUsername:input_type -> ChangeUsernameRequest
	1, // 2: UserService.GetUser:output_type -> GetUserResponse
	1, // 3: UserService.ChangeUsername:output_type -> GetUserResponse
