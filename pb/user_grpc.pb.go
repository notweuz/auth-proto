...
const (
	...
	UserService_ChangeUsername_FullMethodName = "/UserService/ChangeUsername"
)
...
type UserServiceClient interface {
	...
	ChangeUsername(ctx context.Context, in *ChangeUsernameRequest, opts ...grpc.CallOption) (*GetUserResponse, error)
}
...
func (c *userServiceClient) ChangeUsername(ctx context.Context, in *ChangeUsernameRequest, opts ...grpc.CallOption) (*GetUserResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(GetUserResponse)
...
type UserServiceServer interface {
	...
	ChangeUsername(context.Context, *ChangeUsernameRequest) (*GetUserResponse, error)
...
func (UnimplementedUserServiceServer) ChangeUsername(context.Context, *ChangeUsernameRequest) (*GetUserResponse, error) {
